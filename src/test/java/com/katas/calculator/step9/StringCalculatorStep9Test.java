package com.katas.calculator.step9;

import com.katas.calculator.Calculator;
import com.katas.calculator.step9.StringCalculatorStep9;
...
public class StringCalculatorStep9Test {

    private final Calculator calculator = new StringCalculatorStep9();
    ...
    // STEP 9
    @DisplayName("Should return sum when input has an multiple longer-length separators")
    @Test
    public void input_with_multiple_longer_length_separators_return_sum() {
        assertThat(calculator.add("//[foo][bar]\n1foo2bar3"))
                .isEqualTo(6);
    }
